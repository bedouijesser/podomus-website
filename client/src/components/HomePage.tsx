...
export default function HomePage({ services, navigate }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative section-padding bg-gradient-to-br from-[#E8E4D9] to-[#F5F5F5] overflow-hidden">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Hero Content */}
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-[#40826D] text-white px-4 py-2 text-sm font-medium">
                  Cabinet de Podologie Moderne
                </Badge>
                <h1 className="font-serif text-4xl md:text-6xl font-bold text-[#404040] fadeInUp">
                  Soins Experts pour la
                  <span className="text-[#40826D] block">Santé de vos Pieds</span>
                </h1>
                <p className="text-lg text-[#404040]/80 fadeInUp stagger-1 max-w-xl">
              ...
              <div className="space-y-4 fadeInUp stagger-2">
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    className="w-full sm:w-auto border-[#40826D] text-[#40826D] hover:bg-[#40826D] hover:text-white"
                  >
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative w-80 h-80 md:w-96 md:h-96">
                <svg
                  viewBox="0 0 200 250"
                  className="w-full h-full text-[#40826D] wireframe-foot animate-pulse"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1"
                >
                ...
                {/* Floating elements */}
                <div className="absolute -top-4 -right-4 w-8 h-8 bg-[#40826D] rounded-full animate-bounce opacity-70"></div>
                <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-[#C71585] rounded-full animate-bounce opacity-70" style={{animationDelay: '1s'}}></div>
                <div className="absolute top-1/2 -left-8 w-4 h-4 bg-[#40826D] rounded-full animate-bounce opacity-50" style={{animationDelay: '2s'}}></div>
              </div>
            </div>
          </div>
        </div>
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center fadeInUp" style={{animationDelay: `${index * 0.1}s`}}>
                <div className="flex justify-center mb-4">
                  <div className="w-12 h-12 bg-[#40826D]/10 rounded-full flex items-center justify-center">
                    <stat.icon className="w-6 h-6 text-[#40826D]" />
                  </div>
                </div>
                <div className="font-serif text-2xl font-bold text-[#404040] mb-2">
                  {stat.value}
                </div>
      ...
      <section className="section-padding bg-[#F5F5F5]">
        <div className="container-max">
          <div className="text-center mb-12">
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#404040] mb-4 fadeInUp">
              Nos Services Spécialisés
            </h2>
            <p className="text-lg text-[#404040]/70 max-w-2xl mx-auto fadeInUp stagger-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card key={service.id} className="group card-hover bg-white border-0 shadow-lg fadeInUp" style={{animationDelay: `${index * 0.2}s`}}>
                <CardContent className="p-8">
                  <div className="space-y-4">
                    <div className="w-16 h-16 bg-[#40826D]/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-[#40826D] transition-colors duration-300">
                      <div className="w-8 h-8 text-[#40826D] group-hover:text-white transition-colors duration-300">
                    ...
                    <h3 className="font-serif text-xl font-semibold text-[#404040] group-hover:text-[#40826D] transition-colors duration-300">
                      {service.name}
                    </h3>
                    ...
                    <div className="flex items-center justify-between pt-4">
                      <div className="text-sm text-[#404040]/60">
                        ...
                        {service.price && (
                          ...
                          <span className="ml-2 font-semibold text-[#40826D]">
                            {service.price}€
                          </span>
                        )}
                      </div>
                      <Button 
                        ...
                        variant="ghost" 
                        className="text-[#40826D] hover:bg-[#40826D] hover:text-white p-2"
                      >
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 fadeInUp">
              <div className="space-y-4">
                <Badge className="bg-[#C71585]/10 text-[#C71585] px-4 py-2">
                  Dr. Sonda AFFES
                </Badge>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#40826D] rounded-full"></div>
                  <span className="text-[#404040]">Diplôme universitaire en podologie</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#40826D] rounded-full"></div>
                  <span className="text-[#404040]">Spécialisation en orthèses plantaires</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#40826D] rounded-full"></div>
                  <span className="text-[#404040]">Formation continue en podologie avancée</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#40826D] rounded-full"></div>
                  <span className="text-[#404040]">Membre de l'association tunisienne de podologie</span>
                </div>
              </div>
            ...
            <div className="relative fadeInUp stagger-1">
              <div className="aspect-square bg-gradient-to-br from-[#40826D]/10 to-[#C71585]/10 rounded-full flex items-center justify-center">
                <div className="w-4/5 h-4/5 bg-[#40826D]/5 rounded-full flex items-center justify-center">
                  <div className="text-6xl">👩‍⚕️</div>
                </div>
              </div>
              <div className="absolute -top-4 -left-4 w-8 h-8 bg-[#40826D] rounded-full animate-pulse"></div>
              <div className="absolute -bottom-4 -right-4 w-6 h-6 bg-[#C71585] rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-[#F5F5F5]">
        <div className="container-max">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#404040]/70 fadeInUp stagger-1">
                ...
                <div className="text-center space-y-6">
                  <div className="flex justify-center space-x-1 mb-4">
                    {[...Array(testimonials[currentTestimonial].rating)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 fill-[#C71585] text-[#C71585]" />
                    ))}
                  </div>
                  
                  <blockquote className="text-xl md:text-2xl font-serif text-[#404040] italic leading-relaxed">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-[#40826D]">
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentTestimonial ? 'bg-[#40826D] scale-125' : 'bg-[#40826D]/30'
                  }`}
                />
              ))}
            </div>
